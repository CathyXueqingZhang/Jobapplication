...
### Downloading data
Download data from http://coastwatch.pfeg.noaa.gov/erddap/tabledap/ndbcSosWind.html (you may also access it here). For this we will need at least longitude, latitude, station_id, time, wind_from_direction, and wind_speed.
